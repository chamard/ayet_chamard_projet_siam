 ...
 *      designant un deplacement possible ou aucun déplacement.
 *    (c-a-d: gauche, droite, haut ou bas ou rien)
 *    Necessite:
 *      - Une enumeration de type orientation_deplacement
 *    Garantie:
 *      - Un retour valant 1 si l'orientation correspond aux
 *          enumerations designants un deplacement ou aucun déplacement.
 ...
 * Fonction orientation_etre_integre:
 * *************************
 *    vérifie que le caractere est bien un cararactère désignant une direction 
 *         ^
 * soit  <   >  
 *         V
 *    Necessite:
 *      - Un caractere.
 *    Garantie:
 *      - renvoie 1 si le caractère est valide sinon 0
 */
